 ...
 */
package space.testflight.liquibase;
...
import space.testflight.Liquibase;
...
@Liquibase(
  ...
  testDataScripts = {
    "db/second-testdata/second-init.sql",
    "db/second-testdata/initTwo.sql"
  },
  configuration = {
    @ConfigProperty(key = "liquibase.changelogFile", value = "dbchangelog.xml"),
    @ConfigProperty(key = "liquibase.sql.logLevel", value = "INFO"),
